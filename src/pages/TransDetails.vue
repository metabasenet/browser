                    ...
                    <el-col :span="24" :xs="24">
                      <ul>
                        ...
                        <li class="log_li" v-for="(item, index) in transLogs" :key="index">
                          <div>
                            <el-tag type="success" size="large" effect="dark" round><span style="color:#fff">{{item.index}}</span></el-tag>
                          </div>
                          <div style="width: 100%;">
                              ...
                              <el-descriptions-item label="Topics:" label-align="center" align="left"
                                ...
                                <div class="block_height">
                                  <div style="display:flex" v-if="item.from">
                                    <el-tag  type="warning">0:from</el-tag><router-link class="skyblue-text ellipsis-text"
                                      :to="{
                                        name: 'address',
